...
if(isset($_SESSION['Auth']) && $user['ac_status']==1 && !$pagecount){
    ...
    showPage('footer1');
}elseif(isset($_SESSION['Auth']) && isset($_GET['editprofile']) && $user['ac_status']==3){
    showPage('header',['page_title'=>'Edit Profile']);
    showPage('adminnav');
    showPage('edit_profile');
    showPage('footer1');
...
elseif(isset($_SESSION['Auth']) && isset($_GET['u']) && $user['ac_status']==3){
    $profile = getUserByUsername($_GET['u']);
    if(!$profile){
        showPage('header',['page_title'=>'User Not Found']);
        showPage('adminnav');
...
elseif(isset($_SESSION['Auth']) && isset($_GET['dashboard']) && $user['ac_status']==3){
    showPage('header',['page_title'=>'Edit Profile']);
    showPage('adminnav');
    showPage('adminindex');
    showPage('footer1');
...
elseif(isset($_GET['signup'])){
    showPage('header',['page_title'=>'ArcHub - SignUp']);
    showPage('signup');
}elseif(isset($_GET['login'])){
   
    showPage('header',['page_title'=>'ArcHub - Login']);
    showPage('login');
}elseif(isset($_GET['forgotpassword'])){
    
    showPage('header',['page_title'=>'ArcHub - Forgot Password']);
