<?php global $user;?>
    <div class="container main col-md-9 col-sm-12 rounded-0 d-flex justify-content-between mb-5">
...
if(isset($_GET['success'])){
    ?>
<br><p class="text-success">Profile updated Successfully!</p>
...
<?php
                ...
                <div class="form-floating mt-1">
                    <input type="long-text" name="bio" value="<?=$user['bio']?>" class="form-control rounded-0" placeholder="Bio" >
                ...
                <div class="form-floating mt-1 mb-5">
