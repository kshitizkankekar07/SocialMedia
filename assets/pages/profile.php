...
global $user;
?>
    <div class="container main col-md-9 col-sm-11 rounded-0">
...
if(!checkBS($profile['id'])){
 ...
 <span style="font-size: medium;" class="text-secondary"> <?=$profile['bio']?></span>
 </div>
 </div>
 </div>
...
if(checkBS($profile['id'])){
 ...
 <div class="alert alert-secondary text-center" role="alert">
   ...
   <?php
    ...
    echo "<p class='p-2 bg-white border rounded text-center my-3'>No Post Has Been Posted Yet... Stay Tuned</p>";
}
        ?>
