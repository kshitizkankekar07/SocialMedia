<?php
 ...
 ?>
    <div class="container main col-md-10 col-sm-12 col-lg-9 rounded-0 d-flex justify-content-between">
        ...
        <div class="col-md-8 col-sm-12" style="max-width:93vw">
            ...
            if(count($posts)<1){ ?>
                <div class="card-title d-flex justify-content-between  align-items-center">
                    <div class="d-flex" style="padding-left: 110px;">
                        <img src="assets/images/follow.jpg" height="400" width="400">
                    </div>
                </div>
                <div class="card-title d-flex justify-content-between  align-items-center">
                    <div>
                    <p style="font-size: 40px; color: darkblue;">Start Following For intresting content!</p>
                    </div>
                </div>
                <?php } 
                ...
                <div class="input-group p-2 <?=$post['post_text']?'border-top':''?>">
                        ...
                        <input type="text" class="form-control rounded-0 border-0 comment-input" placeholder="say something.."
                            ...
                            <button class="btn btn-outline-primary rounded-0 border-0 add-comment" data-page='wall' data-cs="comment-section<?=$post['id']?>" data-post-id="<?=$post['id']?>" type="button"
                                id="button-addon2"style="z-index:auto;">Post</button>
                </div>
...
<div class="d-flex justify-content-between">
    ...
    <?php
        ...
        <div class="col-lg-4 col-sm-0 followdiv mt-4 p-sm-0 .tooltip ">
       

            <div class="d-flex align-items-center p-2 profile-pic">
