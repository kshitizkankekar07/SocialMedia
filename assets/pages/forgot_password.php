<body class="bd">
    <div class="login">
        <div class="col-lg-4 col-md-8 col-sm-12 bg-transparent bg-white border round p-4 shadow-sm">
            <?php
...
if($action=='forgotpassword'){
  ...
  <div class="form-floating">
                    <input type="contact" name="email" class="form-control bg-transparent rounded-0" placeholder="contact">
                    <label for="floatingInput">enter your Registered Contact Number</label>
                </div>
                <?=showError('email')?>
