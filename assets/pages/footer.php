...
<div class="modal fade" id="addfeedback" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="" style="display:none" id="f_id" class="w-100 rounded border">
                <form method="post" action="assets/php/actions.php?addfeedback" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Say Something</label>
                        <input type="textarea" name="feedback" class="form-control" id="exampleFormControlTextarea1" rows="1"></input=textarea>
                    </div>
...
<img src="assets/images/notify.png" alt="" height="45">
</div>
...
<img src="assets/images/chat.jpg" alt="" height="45">
</div>
</div>
